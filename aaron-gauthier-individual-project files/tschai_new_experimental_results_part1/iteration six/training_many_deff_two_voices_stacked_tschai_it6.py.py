...
def train_lstm_loss_only_last(seq_len, hidden_size=356, num_layers=1, dropout=0,
...
def train_lstm_loss_whole_seq(seq_len, hidden_size=356, num_layers=1, dropout=0,
                              lr=0.01, n_epochs=100, use_all_seq=False, use_n_seq=100):
...
def ltsm_gen(net, seq_len, file_name, sampling_idx=0, n_steps=100, hidden_size=356,
...
def ltsm_gen_v2(net, seq_len, file_name, sampling_idx=0, note_pos=0, n_steps=100, hidden_size=356,
                num_layers=1, time_step=0.05, changing_note=False, note_stuck=False, remove_extra_rests=True):
...
torch.save(net.state_dict(), 'lstm_whole_seq_tschai_it6_both_stacked.pkl')
ltsm_gen_v2(net, 50, "tschai_it6_both_stacked_6", time_step=0.25, n_steps=1000, note_stuck=True)
...
#notes_encoded = load("tschai", "unknown", 5)
#net, l, ll = train_lstm_loss_whole_seq(50, n_epochs=100, lr=0.01)
#torch.save(net.state_dict(), 'lstm_whole_seq_tshai_it5_both_stacked.pkl')
# net = LSTMMusic(178, 178).cuda()
#net.load_state_dict(torch.load("lstm_whole_seq_tschai_it5_both_stacked.pkl"))
#net.eval()
#ltsm_gen_v2(net, 50, "tschai_it5_both_stacked_5", time_step=0.25, n_steps=1000, note_stuck=True)
# Decent!

...
def train_lstm_loss_only_last(seq_len, hidden_size=712, num_layers=1, dropout=0,
                              lr=0.01, n_epochs=100, use_all_seq=False, use_n_seq=20):
...
notes_encoded = load("albeniz", "suite", 10)
net, l, ll = train_lstm_loss_whole_seq(50, n_epochs=100, lr=0.01)
torch.save(net.state_dict(), 'lstm_whole_seq_albeniz_it4_both_stacked.pkl')
# net = LSTMMusic(178, 178).cuda()
net.load_state_dict(torch.load("lstm_whole_seq_albeniz_it4_both_stacked.pkl"))
net.eval()
ltsm_gen_v2(net, 50, "albeniz_it4_both_stacked_3", time_step=0.25, n_steps=1000, note_stuck=True)
# Decent!

...
class LSTMMusic(nn.Module):
    ...
    """
    # Run - Iteration 1 with Albeniz Suite- 8
...
def train_lstm_loss_only_last(seq_len, hidden_size=1424, lr=0.01, n_epochs=100,
...
def train_lstm_loss_whole_seq(seq_len, hidden_size=1424, lr=0.01,
...
def ltsm_gen(net, seq_len, file_name, sampling_index=0, n_steps=100, hidden_size=1424, time_step=0.05):
...
def ltsm_gen_v2(net, seq_len, file_name, sampling_idx=0, n_steps=100, hidden_size=1424,
...
notes_encoded = load("albeniz", "suite", 8)
...
# net.eval()
ltsm_gen_v2(net, 50, "albeniz_it4__both_stacked", time_step=0.25, n_steps=1000)
# Decent!

...
def train_lstm_loss_only_last(seq_len, hidden_size=356, lr=0.01, n_epochs=100,
...
def train_lstm_loss_whole_seq(seq_len, hidden_size=356, lr=0.01,
...
def ltsm_gen(net, seq_len, file_name, sampling_index=0, n_steps=100, hidden_size=356, time_step=0.05):
...
def ltsm_gen_v2(net, seq_len, file_name, sampling_idx=0, n_steps=100, hidden_size=356,
...
torch.save(net.state_dict(), 'lstm_whole_seq_albeniz_it2_both_stacked.pkl')
# net = LSTMMusic(178, 178).cuda()
# net.load_state_dict(torch.load("lstm_whole_seq_mendelssohn_both_stacked.pkl"))
# net.eval()
ltsm_gen_v2(net, 50, "albeniz_it2__both_stacked", time_step=0.25, n_steps=1000)
# Decent!

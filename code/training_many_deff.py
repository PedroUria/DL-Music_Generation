...
# net, l, ll = train_lstm_loss_whole_seq(100, hidden_size=89, lr=0.01, n_epochs=400, use_all_seq=True)
# torch.save(net.state_dict(), 'lstm_bach.pkl')
# net = LSTMMusic(89, 89).cuda()
# net.load_state_dict(torch.load("lstm_bach.pkl"))
# net.eval()
# ltsm_gen_v2(net, 100, "bach_4", hidden_size=89, time_step=0.25, n_steps=1000)

...
def ltsm_gen(net, seq_len, file_name, sampling_idx=0, n_steps=100,
             hidden_size=178, time_step=0.05, changing_note=False):
    ...
    :param changing_note: To sample from different source at some point of the generation
